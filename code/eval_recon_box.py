...
# load train config
# ->
eval_conf.exp_name = 'pre_trained/box_ae_chair'
eval_conf.test_dataset = 'test_no_other_less_than_10_parts.txt'
eval_conf.model_epoch = 101
# <-
file_path = os.path.join(eval_conf.model_path, eval_conf.exp_name, 'conf.pth')
print(file_path)
conf = torch.load(file_path)
